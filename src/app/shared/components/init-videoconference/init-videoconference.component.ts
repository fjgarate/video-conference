...
@Component({
  selector: 'app-init-videoconference',
  templateUrl: './init-videoconference.component.html',
  styleUrls: ['./init-videoconference.component.css']
})
export class InitVideoconferenceComponent implements OnInit {
